    ...
    <head> 
        <body>
            ...
            <div class="box-container2">
                <div id="pic1" class="clearbox" data-aos="zoom-in" data-aos-duration="800" style="margin-left: -1%;">
            ...
            <div class="box-container2">
                <div id="ctg" class="clearbox" data-aos="zoom-in" data-aos-duration="800" style="margin-left: 6%; ">
                    <h3>Fundraising for Breast Cancer Support</h3>
                    <p>&nbsp;</p>
                    <h4>This year we are donating all of our proceeds to the Breast Cancer Fundraiser. The Breast Cancer Fundraiser is an
                ...
                <div id="pic1" class="clearbox" data-aos="zoom-in" data-aos-duration="800" style="margin-left: 0%; margin-right: 6%;">
            ...
            <!-- maybe we can change to fade-up ????-->
            <div id="donate" data-aos="zoom-in" data-aos-duration="800">
                ...
                <p>&nbsp;</p>
                    ...
                    <a target="_blank" href="https://www.goldenguardians.com/"><img src="https://i.imgur.com/flaurNw.png" style="width: 72px; height: 100px"></a>
                    &nbsp; &nbsp;
                        ...
                        <div class="tab-content">
                            ...
                            <div class="ctg-tab active">
                                <div style="margin-left: 0%; margin-bottom: 3%;">
                                    <img class="ctg-img" src="./img/James.jpg" alt="James" style="width: 120px; height: 120px;"></img>
                                ...
                                <div class="ctg-row">
                                    ...
                                    <img class="ctg-img-right" src="./img/Chaya.jpg" alt="Chaya" style="margin-right: 20px;"></img>
                                    <div style="margin-top: 2%;">
                                        <h2>Chaya Pearl</h2>
                                ...
                                <div class="ctg-row">
                                    ...
                                    <img class="ctg-img-right" src="./img/Mercy.jpg" alt="Mercy" style="margin-right: 20px;"></img>
                                    <div style="margin-top: 2%;">
                                ...
                                <div class="ctg-row">
                                    <img class="ctg-img-left" src="./img/Brandon.jpg" alt="Brandon" style="margin-right: 20px;"></img>
                                    <div style="margin-top: 2%;">
                                        <h2>Brandon Kincaid</h2>
                                        <h4 style="width: 10em;">Marketing Chair</h4>
                                    </div>
    
                                    <img class="ctg-img-right" src="./img/CJ.jpg" alt="CJ" style="margin-right: 20px;"></img>
                                    <div style="margin-top: 2%;">
                            ...
                            <div class="ctg-tab">  
                                <div class="ctg-row">
                                    <img class="ctg-img-left" src="./img/Celina.jpg" alt="Celina" style="margin-right: 20px;"></img>
                                    <div style="margin-top: 2%;">
                                        <h2>Celina Tiqui</h2>
                                        <h4 style="width: 10em;">Administrative Intern</h4>
                                    </div>
    
                                    <img class="ctg-img-right" src="./img/Izzabella.jpg" alt="Izzabella" style="margin-right: 20px;"></img>
                                    <div style="margin-top: 2%;">
                                ...
                                <div class="ctg-row">
                                    <img class="ctg-img-left" src="./img/Jon.jpg" alt="Jon" style="margin-right: 20px;"></img>
                                    <div style="margin-top: 2%;">
                                        <h2>Jon Estrada</h2>
                                        <h4 style="width: 10em;">Administrative Intern</h4>
                                    </div>
    
                                    <img class="ctg-img-right" src="./img/Valerie.jpg" alt="Valerie" style="margin-right: 20px;"></img>
                                    <div style="margin-top: 2%;">
                            ...
                            <div class="ctg-tab">
                                <div class="ctg-row">
                                    ...
                                    <img class="ctg-img-right" src="./img/Jen.jpg" alt="Jen" style="margin-right: 20px;"></img>
                                    <div style="margin-top: 2%;">
                                        <h2>Jen Delgado</h2>
                                        <h4 style="width: 10em;">Competitive Intern</h4>
                                    </div>
                                ...
                                <div class="ctg-row">
                                    <img class="ctg-img-left" src="./img/Shania.jpg" alt="Shania" style="margin-right: 20px;"></img>
                                    <div style="margin-top: 2%;">
                            ...
                            <div class="ctg-tab">
                                ...
                                <div class="ctg-row">
                                    ...
                                    <img class="ctg-img-right" src="./img/Ian.jpg" alt="Ian" style="margin-right: 20px;"></img>
                                    <div style="margin-top: 2%;">
                                        <h2>Ian Baylon</h2>
                                        <h4 style="width: 10em;">Creative Intern</h4>
                                    </div>
                                ...
                                <div class="ctg-row">
                                    <img class="ctg-img-left" src="./img/Jay.jpg" alt="Jay" style="margin-right: 20px;"></img>
